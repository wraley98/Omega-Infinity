function [path,v_path] = SL_get_path(airways,v1,v2,props)
% SL_get_path - get lane sequence from v1 to v2 (launch/land vertexes)
% On input:
...
% Call:
%     [path,v_path] = SL_get_path(airways1,70,73,[]);
% Author:
%     T. Henderson
%     UU
%     Fall 2020
...
path = SL_vertexes2lanes(airways,v_path);
tch = 0;
