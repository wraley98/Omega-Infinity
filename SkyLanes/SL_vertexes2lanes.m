function lanes = SL_vertexes2lanes(airways,indexes)
% SL_vertexes2lanes - create lane sequence from vertex sequence
% On input:
...
% Call:
%     lanes = SL_vertexes2lanes([70,28,24,21,48,49,52,73]);
% Author:
%     T. Henderson
%     UU
%     Fall 2020
